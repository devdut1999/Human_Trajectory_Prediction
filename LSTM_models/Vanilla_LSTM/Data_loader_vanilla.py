...
class DataLoader:
    ...
    def load_data(self, samples_to_load, data_path, verbose=False):
        ...
        for file_path in samples_to_load:
            ...
            tracklet = pd.read_csv(data_path + file_path + ".txt" , sep=" ", header=None)
            # tracklet = pd.read_csv(data_path + file_path + '.csv', header=None, delimiter=',')
            ...
            center_traj = (en_cuda(torch.Tensor(center_traj.to_numpy())))
